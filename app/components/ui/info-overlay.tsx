    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            <section
                ...
                className="relative flex max-h-[85vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl bg-card text-foreground shadow-2xl"
            >
                ...
                <div className={`overflow-y-auto px-4 py-4 sm:px-6 sm:py-5 ${contentClassName}`}>
                    {children ? (
                        children
                    ) : details.length > 0 ? (
